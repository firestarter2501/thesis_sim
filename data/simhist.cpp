...
std::cout << "1->2: " << hist2d->Integral(ene1-cutrange, ene1+cutrange, ene2-cutrange, ene2+cutrange) << std::endl;
std::cout << "2->1: " << hist2d->Integral(ene3-cutrange, ene3+cutrange, ene4-cutrange, ene4+cutrange) << std::endl;
